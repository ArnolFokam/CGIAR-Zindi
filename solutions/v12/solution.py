...
from cgiar.labels import transformations
...
if __name__ == "__main__":
    ...
    parser.add_argument("--label_transform", default="idty", type=str, help="Specify label transformation")
    ...
    print(args.model_name, args.index, args.label_transform)
